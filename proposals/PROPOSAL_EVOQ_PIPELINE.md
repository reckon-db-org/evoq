...
**Author:** Raf Lefever
**Date:** 2026-05-25
**Related:** [hecate-corpus/philosophy/COMMAND_PIPELINES.md](https://github.com/hecate-social/hecate-corpus/blob/main/philosophy/COMMAND_PIPELINES.md) (canonical conceptual model)
...
1. **Reading from a read model inside `execute/2`, `apply/2`, or the dispatching handler.** This is [Demon 41 — THE Cardinal Sin](https://github.com/hecate-social/hecate-corpus/blob/main/skills/ANTIPATTERNS_EVENT_SOURCING.md#-demon-41-reading-from-read-models-during-event-flow--the-cardinal-sin). Silent race conditions, replay breakage.
...
- [hecate-corpus/philosophy/COMMAND_PIPELINES.md](https://github.com/hecate-social/hecate-corpus/blob/main/philosophy/COMMAND_PIPELINES.md) — canonical conceptual model, source of truth for the pattern
- [hecate-corpus/skills/codegen/erlang/CODEGEN_ERLANG_PIPELINES.md](https://github.com/hecate-social/hecate-corpus/blob/main/skills/codegen/erlang/CODEGEN_ERLANG_PIPELINES.md) — templates and checklists
- [hecate-corpus/skills/ANTIPATTERNS_EVENT_SOURCING.md#-demon-41](https://github.com/hecate-social/hecate-corpus/blob/main/skills/ANTIPATTERNS_EVENT_SOURCING.md#-demon-41-reading-from-read-models-during-event-flow--the-cardinal-sin) — Demon 41, the cardinal sin this pattern cures
